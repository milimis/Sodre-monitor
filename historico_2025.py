...
# Consultas específicas para 2025 con exclusión explícita de "Cais do Sodré"
CONSULTAS_2025 = [
    'Sodre Uruguay after:2025-01-01 before:2025-12-31 -cais',
    '"Auditorio Nacional Adela Reta" after:2025-01-01 before:2025-12-31',
    '"Ballet Nacional del Sodre" after:2025-01-01 before:2025-12-31',
    '"Orquesta Sinfónica del Sodre" OR OSSODRE after:2025-01-01 before:2025-12-31',
    '"Coro Nacional del Sodre" after:2025-01-01 before:2025-12-31',
    '"Auditorio Nelly Goitiño" after:2025-01-01 before:2025-12-31',
    '"Auditorio Vaz Ferreira" after:2025-01-01 before:2025-12-31',
    '"Sala Hugo Balzo" after:2025-01-01 before:2025-12-31',
    '"Sala Eduardo Fabini" after:2025-01-01 before:2025-12-31',
    'ENFAS Sodre after:2025-01-01 before:2025-12-31',
    'BNS Sodre after:2025-01-01 before:2025-12-31'
]
...
def main():
    ...
    for query in CONSULTAS_2025:
        print(f"\nConsultando histórico 2025: {query}...")
        ...
        try:
            ...
            for entry in feed.entries:
                ...
                # Filtro para descartar referencias a Lisboa/Portugal
                if "cais do sodré" in titulo.lower() or "cais do sodré" in resumen.lower():
                    continue
                ...
                # Validar estrictamente que sea del año 2025
                if fecha and fecha.year != 2025:
                    continue

                print(f"  -> Procesando nota 2025 ({fecha.strftime('%d/%m/%Y') if fecha else 'S/F'}): {titulo[:60]}...")
                ...
                fila = {
                    ...
                    "enlace": enlace,
                    "nivel_coincidencia": "Histórico 2025",
    ...
    if nuevas_filas:
        with open(CSV_PATH, mode="a", newline="", encoding="utf-8") as f:
            ...
            for r in nuevas_filas:
                writer.writerow(r)
        print(f"\n¡Éxito histórico! Se recuperaron {len(nuevas_filas)} noticias del año 2025.")
    else:
        print("\nNo se encontraron noticias adicionales para 2025.")
